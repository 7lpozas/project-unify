      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">Encuentra tu universidad y carrera ideal</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Email: info@unify.cl</li>
              <li className="text-gray-400">Teléfono: +56 2 1234 5678</li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">&copy; 2024 Unify. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
